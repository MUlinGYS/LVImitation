<template>
	<div>
			...
			<el-carousel ref="carousel" :loop="true" :autoplay="true" height="600px" indicator-position="none"
				...
				<el-carousel-item v-for="(item, index) in menu" :key="index">
					<div class="image-container">
						<img :src="item" alt="Carousel Image" style="
								width: 90%;
								height: 100%;
								object-fit: contain;
							" />
		...
		<!-- 介绍 -->
		<div style="height: auto; width: calc(100% - 60px); padding: 25px 30px">
		...
		<div style="height: auto; width: 100%">
			<img v-for="(url, index) in PHAR" :src="url" :key="index"
...
export default {
	...
	computed: {
		...mapState("ladiesAudition", ["commodityID"]),
	},
	methods: {
